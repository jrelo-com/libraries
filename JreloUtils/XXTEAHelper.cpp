...
static char* XXTEAHelper::encryptData(char *input, int inputLen, char *encryptionPassword) {
    int size;
...
static char* XXTEAHelper::decryptData(char *input, int inputLen, char *encryptionPassword) {
